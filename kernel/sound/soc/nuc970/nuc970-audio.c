...
#ifdef CONFIG_SND_SOC_NAU8810
	ret = snd_soc_dai_set_sysclk(codec_dai, NAU8810_SCLK_PLL, 12000000, SND_SOC_CLOCK_OUT);
#else
...
#ifdef CONFIG_SND_SOC_NAU8810
	ret = snd_soc_dai_set_clkdiv(codec_dai, 1, 0xC);		// divide 8 form MCLK to BCLK
#else
...
#ifdef CONFIG_SND_SOC_NAU8810
	ret = snd_soc_dai_set_sysclk(codec_dai, NAU8810_SCLK_PLL, clk, SND_SOC_CLOCK_OUT);
#else
